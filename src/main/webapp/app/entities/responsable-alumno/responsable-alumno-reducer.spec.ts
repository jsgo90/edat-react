...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './responsable-alumno.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESPONSABLEALUMNO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RESPONSABLEALUMNO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RESPONSABLEALUMNO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RESPONSABLEALUMNO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RESPONSABLEALUMNO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RESPONSABLEALUMNO actions', async () => {
      const arg = 42666;
