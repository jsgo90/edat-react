...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AUTORIZADO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AUTORIZADO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AUTORIZADO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AUTORIZADO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AUTORIZADO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AUTORIZADO actions', async () => {
      const arg = 42666;
