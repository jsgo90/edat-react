...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './baneados.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANEADOS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BANEADOS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BANEADOS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BANEADOS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BANEADOS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BANEADOS actions', async () => {
      const arg = 42666;
