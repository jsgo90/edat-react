...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './historial.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HISTORIAL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HISTORIAL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HISTORIAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HISTORIAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HISTORIAL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HISTORIAL actions', async () => {
      const arg = 42666;
